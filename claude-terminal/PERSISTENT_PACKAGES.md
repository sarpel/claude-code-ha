...
/data/home/.local/bin                 # ← persistent Claude Code override
...
# Clone repositories
cd /config
git clone https://github.com/sarpel/claude-code-ha.git
```
...
1. Check the add-on logs: **Settings** → **Add-ons** → **Claude Terminal Pro** → **Log**
