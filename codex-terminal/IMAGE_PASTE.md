...
Codex Terminal Pro now supports pasting and uploading images directly in the web interface! This feature allows you to easily share images with Codex for analysis, OCR, or any other image-related tasks.
...
- Provides file paths for use with Codex CLI
...
6. Use the path with Codex: `analyze /data/images/pasted-123456.png`
...
- No images are sent to external services (except when you use them with Codex)
